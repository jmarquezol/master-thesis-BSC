% One application of the transfer matrix to a temporal state, then truncation back to chi.
% Time runs vertically as in imgs/echo_strip.tex; the tMPO column is closed by the product
% state (small open circles), the boundary tMPS is not.
%
% Standalone: compiles to imgs/apply.pdf.
% Inline:     with \usepackage{standalone}, \input{imgs/apply}.
