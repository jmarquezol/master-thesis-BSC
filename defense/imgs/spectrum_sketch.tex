...
\begin{tikzpicture}[
  ...
  \node[tag, black!55, anchor=north, align=center] at (0,-2.62)
    {$\dfrac{|\mu_i|}{|\mu_0|} = 1 - \dfrac{b_i}{T^2} \;\longrightarrow\; 1$\\[3pt]
     {\footnotesize at finite $T$: $|\mu_i| < |\mu_0|$ by $O(\beta_0/T^2)$}};

  % eigenvalues: same modulus (nearly), phases separated
  \node[pt] (m0) at (32:{\R}) {};
  \node[pt] (m1) at (58:{\R-0.06}) {};
  \node[pt] (m2) at (84:{\R-0.10}) {};
  \node[pt] (m3) at (110:{\R-0.13}) {};
